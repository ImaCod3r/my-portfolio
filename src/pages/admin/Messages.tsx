      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {messages.map((msg) => (
            <div
              key={msg.id}
              className="bg-gray-900 border border-gray-800 p-6 rounded-lg shadow-md hover:border-white/20 transition-colors"
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <a
                      ...
                      className="text-white text-sm hover:underline block truncate opacity-70"
                    >
                      {msg.email}
                    </a>
                  </div>
