        ...
        <div className="grid grid-cols-1 gap-4">
          {projects.length === 0 ? (
            ...
            projects.map((project) => (
              <div
                key={project.id}
                className="bg-gray-900 border border-gray-800 p-4 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4"
              >
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-gray-900 border border-white/20 p-8 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <h3 className="text-2xl font-bold text-white mb-6">
              {currentProject.id ? "Editar" : "Novo"} Projeto
            </h3>
                ...
                <div className="relative">
                  ...
                  {selectedImage && (
                    <p className="text-xs text-white mt-1">
                      Nova imagem selecionada: {selectedImage.name}
                    </p>
                  )}
                </div>
              </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm mt-2 text-red-400/80">
              Esta ação não pode ser desfeita e a imagem associada será
              removida.
            </p>
          </div>
        </div>
