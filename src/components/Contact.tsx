...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="bg-black py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
    >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-lg">
                Se você tem um projeto em mente, uma ideia de negócio ou apenas
                quer bater um papo sobre tecnologia, fique à vontade para entrar
                em contato.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <div>
                  ...
                  <a
                    href="mailto:edsonfreizer@gmail.com"
